...
public class HaversineDistanceTest {
  ...
  public void getDistance_zero() {
    HaversineDistance distance =
        HaversineDistance.with(Location.with(40, 50), Location.with(40, 50));
  ...
  public void getDistance_chicagoToLA() {
    HaversineDistance distance =
        HaversineDistance.with(Location.with(41.87, -87.62), Location.with(33.94, -118.40));
  ...
  public void getDistance_nashvilleToLA() {
    HaversineDistance distance =
        HaversineDistance.with(Location.with(36.12, -86.67), Location.with(33.94, -118.40));
