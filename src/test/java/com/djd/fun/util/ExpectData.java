...
/**
 * Helper to load a text file from resources dir and convert that to String. This is useful in junit
 * test to compare the actual result against expected result.
 *
 * @author JGD
 * @since 8/24/16
 */
