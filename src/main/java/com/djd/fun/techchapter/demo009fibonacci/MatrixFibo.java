 ...
 * According to <a
 * href="http://kukuruku.co/hub/algorithms/the-nth-fibonacci-number-in-olog-n">Source</a> when N >
 * 250 MatrixFibo runs faster than IterativeFibo
 *
 * @author JGD
 * @since 10/4/16
 */
public class MatrixFibo implements Fibonacci {
   ...
   *
   * <p>Note: Time complexity of Matrix implementation is O(log N).
   *
   * @param n > 0
