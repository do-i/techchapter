...
/**
 * CtCI 6th ed. 16.7 Number Max: Write a method that finds the max of two numbers.
...
public class MaxInt {
   ...
   */
  @VisibleForTesting static int signBit(int number) {
   ...
   */
  @VisibleForTesting static int flipSign(int sign) {
    if (sign == 0 || sign == 1) {
      return sign ^ 1;
    }
