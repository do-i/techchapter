 ...
 *
 * <p>Part 8) scheduled thread pool executor with {@link Runnable} task/command.
 *
  ...
  public static void main(String[] params) {
    ...
    try {
      ...
      ScheduledFuture<?> future =
          service.scheduleWithFixedDelay(makeTask("A", 1), initDelay, delayRate, TimeUnit.SECONDS);
