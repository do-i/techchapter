 ...
 *
 * <p>Part 2) single thread executor with {@link java.util.concurrent.Callable} tasks
 *
 * <p>We can do differently using {@link ExecutorService#invokeAll(Collection)}. See Demo003c
 *
 * @author JGD
 * @since 8/27/16
 */
