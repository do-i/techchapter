...
/**
 * static helper class to compute azimuth value from two {@link
 * com.djd.fun.poc.geo.datatype.Location}s <a
 * href="http://www.movable-type.co.uk/scripts/latlong.html">Bearing algorithm</a>
 *
 * @author JGD
 * @since 9/27/16
 */
